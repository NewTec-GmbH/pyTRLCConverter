...
def test_tc_rst_render_md(record_property, capsys, monkeypatch, tmp_path):
    ...
    with open(os.path.join(tmp_path, output_file_name), "r", encoding='utf-8') as generated_md:
        ...
        assert lines[44] == "    |                |                                                                             |\n"
        assert lines[45] == "    |                |                                                                             |\n"
        assert lines[46] == "    |                | **Bold text** and *italic text*.                                            |\n"
        assert lines[47] == "    |                |                                                                             |\n"
        assert lines[48] == "    |                |                                                                             |\n"
        ...
        assert lines[56] == "    |                |                                                                             |\n"
        assert lines[57] == "    |                |                                                                             |\n"
        assert lines[58] == "    |                |   Blockquote example                                                        |\n"
        assert lines[59] == "    |                |                                                                             |\n"
        assert lines[60] == "    |                |                                                                             |\n"
        assert lines[61] == "    |                |                                                                             |\n"
        assert lines[62] == "    |                | `Link to pyTRLCConverter <https://github.com/NewTec-GmbH/pyTRLCConverter>`_ |\n"
        assert lines[63] == "    |                |                                                                             |\n"
        assert lines[64] == "    |                |                                                                             |\n"
        assert lines[65] == "    +----------------+-----------------------------------------------------------------------------+\n"
        assert lines[66] == "    | link           | N/A                                                                         |\n"
        assert lines[67] == "    +----------------+-----------------------------------------------------------------------------+\n"
        assert lines[68] == "    | index          | N/A                                                                         |\n"
        assert lines[69] == "    +----------------+-----------------------------------------------------------------------------+\n"
        assert lines[70] == "    | precision      | N/A                                                                         |\n"
        assert lines[71] == "    +----------------+-----------------------------------------------------------------------------+\n"
        assert lines[72] == "    | valid          | N/A                                                                         |\n"
        assert lines[73] == "    +----------------+-----------------------------------------------------------------------------+\n"
...
def test_tc_rst_render_gfm(record_property, capsys, monkeypatch, tmp_path):
    ...
    with open(os.path.join(tmp_path, output_file_name), "r", encoding='utf-8') as generated_md:
        ...
        assert lines[47] == "    |                |                                                                                                    |\n"
        assert lines[48] == "    |                |                                                                                                    |\n"
        assert lines[49] == "    |                | - [x] Checked task                                                                                 |\n"
        assert lines[50] == "    |                |                                                                                                    |\n"
        assert lines[51] == "    |                |                                                                                                    |\n"
        assert lines[52] == "    |                | - [ ] Unchecked task                                                                               |\n"
        assert lines[53] == "    |                |                                                                                                    |\n"
        assert lines[54] == "    |                |                                                                                                    |\n"
        assert lines[55] == "    |                |                                                                                                    |\n"
        assert lines[56] == "    |                | .. code-block::                                                                                    |\n"
        assert lines[57] == "    |                |                                                                                                    |\n"
        ...
        assert lines[63] == "    |                |                                                                                                    |\n"
        assert lines[64] == "    |                |                                                                                                    |\n"
        assert lines[65] == "    |                | `https://github.com/NewTec-GmbH/pyTRLCConverter <https://github.com/NewTec-GmbH/pyTRLCConverter>`_ |\n"
        assert lines[66] == "    |                |                                                                                                    |\n"
        assert lines[67] == "    |                |                                                                                                    |\n"
        assert lines[68] == "    |                |   Blockquote example                                                                               |\n"
        assert lines[69] == "    |                |                                                                                                    |\n"
        assert lines[70] == "    |                |                                                                                                    |\n"
        assert lines[71] == "    |                |                                                                                                    |\n"
        assert lines[72] == "    |                | `Link to pyTRLCConverter <https://github.com/NewTec-GmbH/pyTRLCConverter>`_                        |\n"
        assert lines[73] == "    |                |                                                                                                    |\n"
        assert lines[74] == "    |                |                                                                                                    |\n"
        assert lines[75] == "    |                | +-------+-------+                                                                                  |\n"
        assert lines[76] == "    |                | | Col 0 | Col 1 |                                                                                  |\n"
        assert lines[77] == "    |                | +=======+=======+                                                                                  |\n"
        assert lines[78] == "    |                | | A     | B     |                                                                                  |\n"
        assert lines[79] == "    |                | +-------+-------+                                                                                  |\n"
        assert lines[80] == "    |                |                                                                                                    |\n"
        assert lines[81] == "    |                |                                                                                                    |\n"
        assert lines[82] == "    |                | ~~I am strikethrough.~~                                                                            |\n"
        assert lines[83] == "    |                |                                                                                                    |\n"
        assert lines[84] == "    |                |                                                                                                    |\n"
        assert lines[85] == "    +----------------+----------------------------------------------------------------------------------------------------+\n"
        assert lines[86] == "    | link           | N/A                                                                                                |\n"
        assert lines[87] == "    +----------------+----------------------------------------------------------------------------------------------------+\n"
        assert lines[88] == "    | index          | N/A                                                                                                |\n"
        assert lines[89] == "    +----------------+----------------------------------------------------------------------------------------------------+\n"
        assert lines[90] == "    | precision      | N/A                                                                                                |\n"
        assert lines[91] == "    +----------------+----------------------------------------------------------------------------------------------------+\n"
        assert lines[92] == "    | valid          | N/A                                                                                                |\n"
        assert lines[93] == "    +----------------+----------------------------------------------------------------------------------------------------+\n"
